...
LTS releases - vendors provide longer support (security and performance patches) for certain Java versions. For Oracle JDK its 3 years, no such support for the fully open-source OpenJDK. LTS versions - Java 8, 11, 17, 21
